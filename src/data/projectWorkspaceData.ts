  ...
  const officers: FieldOfficerRecord[] = [
    {
      ...
      verifiedCount: 42,
      pendingCount: 6,
      lastActivity: 'Today, 10:45 AM (PARCEL-001 DGPS verify)',
      status: 'On Field',
      badgeColor: 'text-amber-700 bg-amber-50 border-amber-300',
      recentParcels: ['PARCEL-001', 'PARCEL-009', 'PARCEL-011', 'PARCEL-012'],
    },
    {
      id: 'PAT-4109',
      ...
      recentParcels: ['PARCEL-006', 'PARCEL-009', 'PARCEL-010', 'PARCEL-012'],
    },
    {
      id: 'SUR-8831',
      ...
      recentParcels: ['PARCEL-007', 'PARCEL-010', 'PARCEL-012', 'P-275'],
    },
    {
      id: 'RNR-1044',
      ...
      recentParcels: ['PARCEL-001', 'PARCEL-006', 'PARCEL-007'],
    },
  ];
  ...
  const activityTimeline: ProjectTimelineEvent[] = [
    {
      ...
      title: 'DGPS Field Inspection Completed for Parcel #PARCEL-001',
